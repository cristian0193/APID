<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="AdminEstados.aspx.cs" Inherits="com.APID.JnJ.PaginasWeb.Administrador.AdminEstados" %>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="PanelPrincipal" runat="server" CssClass="Panel">
                            <table class="auto-style1">
                                ...
                                <tr>
                                    <td class="auto-style2">&nbsp;
                            <asp:Label ID="LBCodigoEstado" runat="server" CssClass="Label" Text="  CODIGO :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TXTCodigoEstado" runat="server" CssClass="TextBox" Width="10%" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBNombreEstado" runat="server" CssClass="Label" Text="NOMBRE DE ESTADO :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTNombreEstado" runat="server" CssClass="TextBox" Width="30%"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBReferenciaEstado" runat="server" CssClass="Label" Text="ESTADO REFERENCIA :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTReferenciaEstado" runat="server" CssClass="TextBox" Width="7%"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBReferenciaTipo" runat="server" CssClass="Label" Text="TIPO REFERENCIA :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTReferenciaTipo" runat="server" CssClass="TextBox" Width="7%" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
            ...
            <td class="auto-style3">
                ...
                <asp:Button ID="BTConsultar" runat="server" CssClass="Button"
                    Text="Consultar" />
                        ...
                        <%--PANEL 2--%>
                        <asp:Panel ID="PNPrueba" runat="server" GroupingText="Tabla de Datos de Estados" CssClass="Panel" Width="600px" Height="400px" Style="background: white;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;<asp:DropDownList ID="ListaFiltro" runat="server" CssClass="DropDown">
                                            ...
                                            <asp:ListItem Value="ID_ESTADO">ID</asp:ListItem>
                                            <asp:ListItem Value="NOMBRE_ESTADO">Nombre</asp:ListItem>
                                            <asp:ListItem Value="REFERENCIA_ESTADO">Referencia</asp:ListItem>
                                            <asp:ListItem Value="REFERENCIA_TIPO">Tipo</asp:ListItem>
                                            <asp:ListItem Value="ID_ESTADO">Todos</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow-y: scroll;" class="scroll">
                                            <center>
                                                <asp:GridView ID="gvEstados" runat="server" AutoGenerateColumns="False" CssClass="ui-table" Width="499px" PageSize="6" >
                                                    <Columns>
                                                        <asp:BoundField DataField="ID_ESTADO" HeaderText="ID_CARGO" />
                                                        <asp:BoundField DataField="NOMBRE_ESTADO" HeaderText="NOMBRE_CARGO" />    
                                                        <asp:BoundField DataField="REFERENCIA_ESTADO" HeaderText="REFERENCIA_ESTADO" />     
                                                        <asp:BoundField DataField="REFERENCIA_TIPO" HeaderText="REFERENCIA_TIPO" />                                                     
