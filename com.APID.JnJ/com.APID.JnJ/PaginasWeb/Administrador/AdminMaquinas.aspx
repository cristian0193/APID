<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="AdminMaquinas.aspx.cs" Inherits="com.APID.JnJ.PaginasWeb.Administrador.AdminMaquinas" %>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="PanelPrincipal" runat="server" CssClass="Panel">
                            <table class="auto-style1">
                                ...
                                <tr>
                                    <td class="auto-style2">&nbsp;
                            <asp:Label ID="LBCodigoMaquinas" runat="server" CssClass="Label" Text="  CODIGO :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TXTCodigoMaquinas" runat="server" CssClass="TextBox" Width="10%" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBNombreMaquinas" runat="server" CssClass="Label" Text="NOMBRE DE MAQUINA :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTNombreMaquinas" runat="server" CssClass="TextBox" Width="30%"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBReferenciaMaquinas" runat="server" CssClass="Label" Text="ESTADO REFERENCIA :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTReferenciaMaquina" runat="server" CssClass="TextBox" Width="7%"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBPlantas" runat="server" CssClass="Label" Text="PLANTAS:"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DropDownPlanta" runat="server" CssClass="DropDown"></asp:DropDownList>                                       
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;<asp:DropDownList ID="ListaFiltro" runat="server" CssClass="DropDown">
                                            ...
                                            <asp:ListItem Value="ID_MAQUINA">ID</asp:ListItem>
                                            <asp:ListItem Value="NOMBRE_MAQUINA">Nombre</asp:ListItem>
                                            <asp:ListItem Value="REFERENCIA_MAQUINA">Referencia</asp:ListItem>
                                            <asp:ListItem Value="ID_CODIGO_PLANTA">Plantas</asp:ListItem>
                                            <asp:ListItem Value="ID_MAQUINA">Todos</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow-y: scroll;" class="scroll">
                                            <center>
                                                <asp:GridView ID="gvMaquinas" runat="server" AutoGenerateColumns="False" CssClass="ui-table" Width="499px" PageSize="6" >
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="REFERENCIA_MAQUINA" HeaderText="REFERENCIA" />     
                                                        <asp:BoundField DataField="ID_CODIGO_PLANTA" HeaderText="PLANTAS" />                                                     
