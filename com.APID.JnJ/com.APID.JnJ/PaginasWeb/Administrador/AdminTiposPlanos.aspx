<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="AdminTiposPlanos.aspx.cs" Inherits="com.APID.JnJ.PaginasWeb.Administrador.AdminTiposPlanos" %>
        ...
        <tr>
            <td colspan="6">
                <asp:Label ID="LBTitulo" runat="server" CssClass="LabelTitulo"
                    Text="Tipos de Planos"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="6">&nbsp;</td>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="PanelPrincipal" runat="server" CssClass="Panel">
                            ...
                            <asp:Label ID="LBCodigoCargo" runat="server" CssClass="Label" Text="  CODIGO :"></asp:Label>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TXTCodigoTiposPlanos" runat="server" CssClass="TextBox" Width="10%" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style2">
                                        ...
                                        <asp:Label ID="LBNombreTiposPlanos" runat="server" CssClass="Label" Text="TIPO DE PLANO :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTNombreTiposPlanos" runat="server" CssClass="TextBox" Width="30%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style2">
                                        <asp:Label ID="Label2" runat="server" CssClass="LabelError" Text="*"></asp:Label>
                                        <asp:Label ID="LBRefenciaTiposPlanos" runat="server" CssClass="Label" Text="REFERENCIA :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TxTReferenciaTiposPlanos" runat="server" CssClass="TextBox" Width="5%" MaxLength="2"></asp:TextBox>
                                    </td>
                                </tr>
            ...
            <td class="auto-style3">
                ...
                <asp:Button ID="BTConsultar" runat="server" CssClass="Button"
                    Text="Consultar" />
                        ...
                        <%--PANEL 2--%>
                        <asp:Panel ID="PNPrueba" runat="server" GroupingText="Tabla de Datos de Tipo de Planos" CssClass="Panel" Width="900px" Height="400px" Style="background: white;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;<asp:DropDownList ID="ListaFiltro" runat="server" CssClass="DropDown">
                                            ...
                                            <asp:ListItem Value="ID_TIPO_PLANOS">ID</asp:ListItem>
                                            <asp:ListItem Value="NOMBRE_TIPO">Nombre</asp:ListItem>
                                            <asp:ListItem Value="REFERENCIA_TIPO_PLANO">Referencia</asp:ListItem>
                                            <asp:ListItem Value="ID_TIPO_PLANOS">Todos</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow-y: scroll;" class="scroll">
                                            <center>
                                                <asp:GridView ID="gvTipoPlanos" runat="server" AutoGenerateColumns="False" CssClass="ui-table" Width="730px" PageSize="6" >
                                                    <Columns>
                                                        <asp:BoundField DataField="ID_TIPO_PLANOS" HeaderText="ID_TIPO_PLANOS" />
                                                        <asp:BoundField DataField="NOMBRE_TIPO" HeaderText="NOMBRE_TIPO" />
                                                        <asp:BoundField DataField="REFERENCIA_TIPO_PLANO" HeaderText="REFERENCIA" />
